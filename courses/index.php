...
$APPLICATION->SetPageProperty("title", "Направления курсов Академии Информационных Систем");
...
?><?$APPLICATION->IncludeComponent(
	...
	array(
		...
		"CACHE_GROUPS" => "N",
		"CACHE_TIME" => "86400",
		"CACHE_TYPE" => ($USER->IsAdmin()|| $_SERVER['REMOTE_ADDR'] == '83.234.200.157')?"N":"A",
		...
		"DISPLAY_TOP_PAGER" => "N",
		"ELEMENT_SORT_FIELD" => "PROPERTY_DATE",
		"ELEMENT_SORT_FIELD2" => "PROPERTY_DATE",
