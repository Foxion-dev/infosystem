		...
		if (!empty($arSource))
		{
			?>
				<div class="row">
					...
					{
						?>
						<div class="col-12 col-sm-12 col-md-12 col-lg-4 col-xl-4" data-property-id-row="<?=intval(intval($arProperties["ID"]))?>">
						...
						elseif ($arProperties["TYPE"] == "TEXT")
						{
                            ...
                            <div class="form-group">
                                <label>
                                    <?=$arProperties["NAME"]?>
                                    <?if ($arProperties["REQUIED_FORMATED"]=="Y"):?>
                                        <span class="bx_req">*</span>
                                    <?endif;?>
                                </label>
                                <input type="text" maxlength="250" size="<?=$arProperties["SIZE1"]?>" value="<?=$arProperties["VALUE"]?>" name="<?=$arProperties["FIELD_NAME"]?>" id="<?=$arProperties["FIELD_NAME"]?>" class="form-control input-lg <?=($arProperties["REQUIED_FORMATED"]=="Y"?"req":"")?>" />
                                <? if (strlen(trim($arProperties["DESCRIPTION"])) > 0): ?>
                                <div class="bx_description">
                                    <?=$arProperties["DESCRIPTION"]?>
                                </div>
						...
						elseif ($arProperties["TYPE"] == "TEXTAREA")
						{
                            ...
                            <div class="form-group">
								...
								<textarea class="form-control input-lg" rows="<?=$rows?>" cols="<?=$arProperties["SIZE1"]?>" name="<?=$arProperties["FIELD_NAME"]?>" id="<?=$arProperties["FIELD_NAME"]?>"><?=$arProperties["VALUE"]?></textarea>
								<? if (strlen(trim($arProperties["DESCRIPTION"])) > 0): ?>
                                    <div class="bx_description">
                                        <?=$arProperties["DESCRIPTION"]?>
                                    </div>
