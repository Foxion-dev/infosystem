...
$arDefaultUrlTemplates404 = array(
    "smart_filter_section" => "filter/#SMART_FILTER_PATH#/apply/",
	"sections" => "",
	"section" => "#SECTION_CODE#/",
	"element" => "#SECTION_CODE#/#ELEMENT_CODE#/",
	"compare" => "compare.php?action=COMPARE",
	"smart_filter" => $smartBase."filter/#SMART_FILTER_PATH#/apply/",
    "reg" => "#SECTION_CODE#/#ELEMENT_CODE#/reg/",
    "kp" => "#SECTION_CODE#/#ELEMENT_CODE#/kp/",
);
...
if($arParams["SEF_MODE"] == "Y")
{
    ...
    /*AddMessage2Log("\n".var_export($arDefaultUrlTemplates404, true). " \n \r\n ", "arDefaultUrlTemplates404");
    AddMessage2Log("\n".var_export($arUrlTemplates, true). " \n \r\n ", "arUrlTemplates");
    AddMessage2Log("\n".var_export($arParams["SEF_FOLDER"], true). " \n \r\n ", "SEF_FOLDER");
    AddMessage2Log("\n".var_export($componentPage, true). " \n \r\n ", "componentPage");
    AddMessage2Log("\n".var_export($arVariables, true). " \n \r\n ", "arVariables");*/
    //
    if ($componentPage === "smart_filter_section")
