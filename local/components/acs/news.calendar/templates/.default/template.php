...
?>
<section class="user-calendar" role="main"><div class="container">
<div class="news-calendar">
	...
	<tr>
		...
		<td align="left" valign="top" class='<?=$arDay["td_class"]?>' width="14%">
			...
			<?foreach($arDay["events"] as $arEvent):?>
				<div class="NewsCalNews"><?=$arEvent["time"]?><a href="<?=$arEvent["url"]?>" title="<?=$arEvent["preview"]?>"><?=$arEvent["title"]?></a></div>
			<?endforeach?>
		</td>
		<?endforeach?>
	</tr >
    ...
    <div class="alert alert-success">
        В календаре отображаются список дат событий, добавленных пользователем в просмотре курса при нажатии на <i class="fa fa-calendar" aria-hidden="true"></i> календарь
    </div>
</div>
</div></section>
