...
<div class="container experts">
    ...
    <div class="heading-wrapper"><h5><?=$arParams['TITLE_PAGE']?></h5><?if($arParams['TITLE_PAGE_URL']):?><a href="<?=$arParams['TITLE_PAGE_URL']?>" class="button button--common button--primary">Все эксперты</a><?endif;?></div>
        <div class="row">
