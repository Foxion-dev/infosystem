...
if($arParams["NEWS_COUNT"]) {
    ...
    $arNavStartParams = ["nTopCount" => $arParams["NEWS_COUNT"]];
}else{
...
//
if($this->startResultCache(false, [($arParams["CACHE_GROUPS"]==="N"? false: $USER->GetGroups()),$arrFilter,$arNavStartParams]))
{
	...
	$rsItems = CIBlockElement::GetList($arOrder, array_merge($arFilter, $arrFilter), false, $arNavStartParams, $arSelect);
