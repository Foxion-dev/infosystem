            ...
            <div class="row">
                <div class="col">
                    <div class="heading-wrapper">
                        ...
                        <a href="<?=$arParams['TITLE_PAGE_URL']?>" class="button button--common button--primary">Видеогалерея</a>
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-12 col-sm-12 col-md-6 col-lg-3 col-xl-3">
                    <a href="<?=$arItem['PROPERTIES']['YOUTUBE']['VALUE']?>" class="news-item fancybox-media">
