...
<div class="bx_mfeedback bx_<?=$arResult["THEME"]?>">
	...
	<form action="<?=POST_FORM_ACTION_URI?>" method="POST">
		...
		<input type="text" class="form-control" name="user_name" value="<?=$arResult["AUTHOR_NAME"]?>"/><br/>
		...
		<input type="text" class="form-control" name="user_email" value="<?=$arResult["AUTHOR_EMAIL"]?>"/><br/>
		...
		<textarea name="MESSAGE" class="form-control" rows="5" cols="40"><?=$arResult["MESSAGE"]?></textarea><br/>
		...
		<?if($arParams["USE_CAPTCHA"] == "Y"):?>
			...
			<input type="text" class="form-control" name="captcha_word" size="30" maxlength="50" value=""/><br/>
		<?endif;?>

		<input type="hidden" name="PARAMS_HASH" value="<?=$arResult["PARAMS_HASH"]?>">
		<input type="submit" name="submit" value="<?=GetMessage("MFT_SUBMIT")?>" class="button button--common button--primary">
	</form>
</div>