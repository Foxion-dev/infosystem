 ...
 */
/*p($arParams['PRODUCT_BLOCKS_ORDER'],'p');
p($arParams['COLUMNS_LIST'],'p');*/
//
...
<script id="basket-item-template" type="text/html">
	<div class="basket-items-list-item-container{{#SHOW_RESTORE}} basket-items-list-item-container-expend{{/SHOW_RESTORE}}"
		id="basket-item-{{ID}}" data-entity="basket-item" data-id="{{ID}}"><div class="row">
		{{#SHOW_RESTORE}}
		...
		{{/SHOW_RESTORE}}
		{{^SHOW_RESTORE}}
            <div class="col-12 basket-title date icon-calendar">
                {{#PROPERTY_DATE_VALUE}}
                    {{PROPERTY_DATE_VALUE}} |
                {{/PROPERTY_DATE_VALUE}}
                {{#PROPERTY_CITY_VALUE}}
            ...
            <div class="col-12 col-sm-12 col-md-12 col-lg-3">
				<div class="basket-item-block-price">
					<select required="" onchange="SetCourseDate(this);" class="basket-product-date" data-id="{{ID}}" style="width: 100%;">
						<option> Выбрать дату курса:</option>
						{{#COURSE_DATES_LIST}}
							<option {{#ACT}}selected=""{{/ACT}} value="{{VALUE}}"> {{NAME}}</option>
						{{/COURSE_DATES_LIST}}
					</select>
					{{#SHOW_LOADING}}
						<div class="basket-items-list-item-overlay"></div>
			...
			if ($useSumColumn)
			{
				?><div class="col-12 col-sm-12 col-md-3 col-lg-2 col-xl-2" style="display:none">
			...
			if ($useActionColumn)
			{
				?><div class="col-12 col-sm-12 col-md-3 col-lg-1 hidden-xs">
