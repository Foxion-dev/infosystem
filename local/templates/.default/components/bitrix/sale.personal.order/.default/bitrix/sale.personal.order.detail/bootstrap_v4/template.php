...
?>
<div class="bx-sale-personal-order-detail tpl-bootstrap-v4">
<?
...
{
    Asset::getInstance()->addJs("/local/templates/.default/components/bitrix/sale.order.payment.change/bootstrap_v4/script.js");
    Asset::getInstance()->addCss("/local/templates/.default/components/bitrix/sale.order.payment.change/bootstrap_v4/style.css");
}
		...
		<div class="col">
			...
			<div class="row mb-3">
				<div class="col border border-info">
					...
					<div class="row">
						<h2 class="col g-font-size-17 pt-2 pb-2 mb-0 bg-info text-white">
					...
					<div class="row mb-3">
						<div class="col">
							<div class="row">
								<h3 class="col g-font-size-15 mb-3 mt-0 pt-2 pb-2 sale-order-section-title">Договор оферты</h3>
							</div>
							<div class="row">
								<div class="col-12 mb-3">
									<a href="/about/contract_offer/" target="_blank">Договор оферты</a>
								</div>
							</div>
						</div>
					</div>
					<div class="row mb-3">
						<div class="col">
							<div class="row">
								<h3 class="col g-font-size-15 mb-3 mt-0 pt-2 pb-2 sale-order-section-title"><?= Loc::getMessage('SPOD_LIST_ORDER_INFO') ?></h3>
							</div>
							<div class="row">
								<div class="col">
									<div class="row">
										<div class="col-sm mb-3">
											...
											<a style="display: none;" class="sale-order-detail-about-order-inner-container-name-read-less"><?= Loc::getMessage('SPOD_LIST_LESS') ?></a>
											<a class="sale-order-detail-about-order-inner-container-name-read-more"><?= Loc::getMessage('SPOD_LIST_MORE') ?></a>
										</div>

										<div class="col-sm mb-3">
											<div><?= Loc::getMessage('SPOD_LIST_CURRENT_STATUS', array(
													'#DATE_ORDER_CREATE#' => $arResult["DATE_INSERT_FORMATED"]
												)) ?></div>
										...
										<div class="col-sm mb-3">
											...
											<div class="sale-order-detail-about-order-inner-container-price-detail"><?= $arResult["PRICE_FORMATED"]?></div>
										</div>
										...
										<?
											if ($arParams['GUEST_MODE'] !== 'Y')
											{
												...
												<div class="col-sm-auto mb-3 text-center">
													<?/*<a href="<?=$arResult["URL_TO_COPY"]?>" class="btn btn-primary btn-block mb-3"><?= Loc::getMessage('SPOD_ORDER_REPEAT') ?></a>*/?>
													<?
													if ($arResult["CAN_CANCEL"] === "Y")
													{
														?>
														<a class="bx-btn" href="<?=$arResult["URL_TO_CANCEL"]?>" class=""><?= Loc::getMessage('SPOD_ORDER_CANCEL') ?></a>
														<?
													}
													?>
												</div>
									...
									<div class="row sale-order-detail-about-order-inner-container-details" style="display: none;">
										<div class="col">
											<h4 class="sale-order-detail-about-order-inner-container-details-title"><?= Loc::getMessage('SPOD_USER_INFORMATION') ?></h4>
											<?
												if (strlen($arResult["USER"]["LOGIN"]) && !in_array("LOGIN", $arParams['HIDE_USER_INFO']))
												{
													?>
													<div class="row mb-3">
														<div class="col-lg-2 col-sm-3"><?= Loc::getMessage('SPOD_LOGIN')?>:</div>
														<div class="col sale-order-detail-about-order-inner-container-list-item-element">
												...
												if (strlen($arResult["USER"]["EMAIL"]) && !in_array("EMAIL", $arParams['HIDE_USER_INFO']))
												{
													?>
													<div class="row mb-3">
														<div class="col-lg-2 col-sm-3"><?= Loc::getMessage('SPOD_EMAIL')?>:</div>
														<div class="col">
												...
												if (strlen($arResult["USER"]["PERSON_TYPE_NAME"]) && !in_array("PERSON_TYPE_NAME", $arParams['HIDE_USER_INFO']))
												{
													?>
													<div class="row mb-3">
														<div class="col-lg-2 col-sm-3"><?= Loc::getMessage('SPOD_PERSON_TYPE_NAME') ?>:</div>
														<div class="col sale-order-detail-about-order-inner-container-list-item-element">
												...
												if (isset($arResult["ORDER_PROPS"]))
												{
													foreach ($arResult["ORDER_PROPS"] as $property)
													{
														?>
														<div class="row mb-3">
															<div class="col-lg-2 col-sm-3"><?= htmlspecialcharsbx($property['NAME']) ?>:</div>
															<div class="col sale-order-detail-about-order-inner-container-list-item-element">
																<?
											...
											{
												?>
												<h4 class="sale-order-detail-about-order-inner-container-details-title sale-order-detail-about-order-inner-container-comments"><?= Loc::getMessage('SPOD_ORDER_DESC') ?></h4>
												<div class="col sale-order-detail-about-order-inner-container-list-item-element"><?=nl2br(htmlspecialcharsbx($arResult["USER_DESCRIPTION"]))?></div>
												<?
											}
											?>
										</div>
					...
					<div class="row mb-3 sale-order-detail-payment-options">
						<div class="col">

							<div class="row">
								<h3 class="col g-font-size-15 mb-3 mt-0 pt-2 pb-2 sale-order-section-title"><?= Loc::getMessage('SPOD_ORDER_PAYMENT') ?></h3>
							</div>
							...
							<div class="row">
								<div class="col">
									...
									<div class="row">
										<div class="col sale-order-detail-payment-options-info">

											<div class="row align-items-center">
												<div class="col-lg-1 col-md-2 col-xs-2 d-none d-sm-block sale-order-detail-payment-options-info-image"></div>
												<div class="col">
											...
											foreach ($arResult['PAYMENT'] as $payment)
											{
												...
												<div class="row payment-options-methods-row">
													<div class="col sale-order-detail-payment-options-methods">
														<div class="row align-items-center sale-order-detail-payment-options-methods-information-block">
															...
															{
																?>
																<div class="col-md-2 col-sm-12 sale-order-detail-payment-options-methods-button-container">
																	<?
																	if ($payment['PAY_SYSTEM']['PSA_NEW_WINDOW'] === 'Y' && $arResult["IS_ALLOW_PAY"] !== "N")
																	{
																		?>
																		<a class="btn btn-primary btn-block bx-btn " target="_blank" href="<?=htmlspecialcharsbx($payment['PAY_SYSTEM']['PSA_ACTION_FILE'])?>"><?= Loc::getMessage('SPOD_ORDER_PAY') ?></a>
																		<?
																	}
																	else
																	{
																		...
																		{
																			?>
																			<button class="btn btn-primary btn-block disabled bx-btn"><?= Loc::getMessage('SPOD_ORDER_PAY') ?></button>
																			<?
																		}
																		else
																		{
																			?>
																			<button class="button button--common button--primary active-button"><?= Loc::getMessage('SPOD_ORDER_PAY') ?></button>
																			<?
																		}
																	}
																	?>
					...
					if (count($arResult['SHIPMENT']))
					{
						...
						<div class="row mb-3">
							<div class="col">
								...
								<div class="row">
									<h3 class="col g-font-size-15 mb-3 mt-0 pt-2 pb-2 sale-order-section-title"><?= Loc::getMessage('SPOD_ORDER_SHIPMENT') ?></h3>
								</div>
											...
											<div class="col sale-order-detail-payment-options-shipment">
													...
													<div class="col sale-order-detail-payment-options-methods-shipment-list">
														...
														<? if (strlen($shipment['TRACKING_URL']))
														{
															...
															<div class="mb-2 sale-order-detail-payment-options-shipment-button-container">
																<a class="sale-order-detail-payment-options-shipment-button-element" href="<?=$shipment['TRACKING_URL']?>"><?= Loc::getMessage('SPOD_ORDER_CHECK_TRACKING')?></a>
															</div>
														<? } ?>
														<div class="mt-3 mb-2 sale-order-detail-payment-options-methods-shipment-list-item-link">
															<a href="" class="sale-order-detail-show-link"><?= Loc::getMessage('SPOD_LIST_SHOW_ALL')?></a>
															<a href="" class="sale-order-detail-hide-link"><?= Loc::getMessage('SPOD_LIST_LESS')?></a>
														</div>
													</div>
												</div>
												<div class="row sale-order-detail-payment-options-shipment-composition-map" style="display: none;">
													<div class="col ">
														...
														if (isset($store))
														{
															...
															<div class="row">
																<div class="col sale-order-detail-map-container">
																	<div class="row">
																		<h4 class="sale-order-detail-payment-options-shipment-composition-map-title"><?= Loc::getMessage('SPOD_SHIPMENT_STORE')?></h4>
																		<?
														...
														?>
														<div class="row">
															<div class="col sale-order-detail-payment-options-shipment-composition-container">
																<div class="row">
																	<div class="col sale-order-detail-payment-options-shipment-composition-title">
																...
																<div class="row">
																	<div class="col sale-order-detail-order-section bx-active">
																						...
																						<?
																							foreach ($shipment['ITEMS'] as $item)
																							{
																								...
																								<tr>
																									...
																									<td class="sale-order-detail-order-item-content">
																										<div class="sale-order-detail-order-item-properties">
																											<a class="sale-order-detail-order-item-title" href="<?=htmlspecialcharsbx($basketItem['DETAIL_PAGE_URL'])?>"><?=htmlspecialcharsbx($basketItem['NAME'])?></a>
																										</div>
																										<?
																											if (isset($basketItem['PROPS']) && is_array($basketItem['PROPS']))
																											{
																												foreach ($basketItem['PROPS'] as $itemProps)
																												{
																													?>
																													<div class="sale-order-detail-order-item-properties">
																														<span class="sale-order-detail-order-item-properties-name"><?= htmlspecialcharsbx($itemProps['NAME']) ?>:</span>
																														<span class="sale-order-detail-order-item-properties-type"><?= htmlspecialcharsbx($itemProps['VALUE']) ?></span>
																													</div>
																													<?
																												}
																											}
																									...
																									<td>
																										<div class="sale-order-detail-order-item-properties">
																											<span class="sale-order-detail-order-item-properties-name"><?= Loc::getMessage('SPOD_QUANTITY')?>:</span>
																											<span class="sale-order-detail-order-item-properties-type"><?=$item['QUANTITY']?>&nbsp;<?=htmlspecialcharsbx($item['MEASURE_NAME'])?></span>
																										</div>
																									</td>
																								</tr>
																								<?
					...
					<div class="row ">
						<h3 class="col g-font-size-15 mb-3 mt-0 pt-2 pb-2 sale-order-section-title"><?= Loc::getMessage('SPOD_ORDER_BASKET')?></h3>
					</div>
					<div class="row">
						<div class="col">
							<div class="sale-order-detail-order-section bx-active">
								<div class="sale-order-detail-order-section-content">
									<div class="table-responsive">
										<table class="table" style="width: 100%" border="0" cellpadding="10" cellspacing="1">
											<thead>
												<tr>
													<?/*<th scope="col"></th>*/?>
													<th scope="col" style="text-align: left;"><?= Loc::getMessage('SPOD_NAME')?></th>
													<th scope="col" style="text-align: left;"><?= Loc::getMessage('SPOD_PRICE')?></th>
													<?
													...
													?>
													<th scope="col" style="text-align: left;"><?= Loc::getMessage('SPOD_QUANTITY')?></th>
													<th style="text-align: left;"><?= Loc::getMessage('SPOD_ORDER_PRICE')?></th>
												</tr>
											</thead>
											<tbody>
											<?
											foreach ($arResult['BASKET'] as $basketItem)
											{
												...
												<tr>
													...
													<td class="sale-order-detail-order-item-content">
														<div class="sale-order-detail-order-item-properties">
															<a class="sale-order-detail-order-item-title" href="<?=$basketItem['DETAIL_PAGE_URL']?>"><?=htmlspecialcharsbx($basketItem['NAME'])?></a>
														</div>
														<?
															if (isset($basketItem['PROPS']) && is_array($basketItem['PROPS']))
															{
													...
													<td>
														<div class="sale-order-detail-order-item-properties">
															<span class="sale-order-detail-order-item-properties-type"><strong class="bx-price"><?=$basketItem['BASE_PRICE_FORMATED']?></strong></span>
														</div>
													</td>
													<?
													...
													<td>
														<div class="sale-order-detail-order-item-properties">
															<span class="sale-order-detail-order-item-properties-type">
																<?=$basketItem['QUANTITY']?>&nbsp;
																<?
					...
					<div class="row sale-order-detail-total-payment">
						<div class="col sale-order-detail-total-payment-container">
							<div class="row">
								<ul class="col-md-10 col sale-order-detail-total-payment-list-left">
								...
								<ul class="col-md-2 col sale-order-detail-total-payment-list-right">
									<?
									if (floatval($arResult["ORDER_WEIGHT"])) { ?>
