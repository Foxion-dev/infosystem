...
?>
<div class="bx-sale-personal-order-list tpl-bootstrap-v4">
<?
use Bitrix\Main,
	...
	if ($_REQUEST["filter_history"] !== 'Y')
	{
		...
		foreach ($arResult['ORDERS'] as $key => $order)
		{
			if ($orderHeaderStatus !== $order['ORDER']['STATUS_ID'] && $arResult['SORT_TYPE'] == 'STATUS')
			{
				...
				<div class="row mb-3">
					<div class="col">
						<h2 class="personal-order-title"><?= Loc::getMessage('SPOL_TPL_ORDER_IN_STATUSES') ?> &laquo;<?=htmlspecialcharsbx($arResult['INFO']['STATUS'][$orderHeaderStatus]['NAME'])?>&raquo;</h2>
					</div>
				</div>
				<?
			}
			...
			<div class="row sale-order-list-title-container">
				<h3 class="col g-font-size-20 mb-1 mt-1">
			...
			<div class="row mb-5">
					<div class="col pt-3 sale-order-list-inner-container">
									...
									<div class="row">
										...
										if ($payment['PAID'] === 'N' && $payment['IS_CASH'] !== 'Y')
										{
											...
											elseif ($payment['NEW_WINDOW'] === 'Y')
											{
												?>
												<div class="col-sm-auto  sale-order-list-button-container">
													<a class="btn btn-primary bx-btn" target="_blank" href="<?=htmlspecialcharsbx($payment['PSA_ACTION_FILE'])?>"><?=Loc::getMessage('SPOL_TPL_PAY')?></a>
												</div>
												<?
											}
											else
											{
												?>
												<div class="col-sm-auto  sale-order-list-button-container">
													<a class="btn btn-primary ajax_reload bx-btn" href="<?=htmlspecialcharsbx($payment['PSA_ACTION_FILE'])?>"><?=Loc::getMessage('SPOL_TPL_PAY')?></a>
												</div>
												<?
											}
										}
						...
						*/?>
						...
						<div class="row mb-3 align-items-center">
							<div class="col-auto">
								<span class="sale-order-list-inner-title-line-item">Договор оферты</span>
							</div>
							<div class="col">
								<hr class="sale-order-list-inner-title-line" />
							</div>
						...
						*/?>
						<div class="row mb-3" style="padding: 0px 0px 20px 0px;">
							<div class="col sale-order-list-inner-row-body">
								<div class="row">
									<div class="col">
						...
						<div class="row pb-3 sale-order-list-inner-row">
							<div class="col-auto sale-order-list-about-container">
								<a class="bx-btn g-font-size-15 sale-order-list-about-link" href="<?=htmlspecialcharsbx($order["ORDER"]["URL_TO_DETAIL"])?>"><?=Loc::getMessage('SPOL_TPL_MORE_ON_ORDER')?></a>
							</div>
							<div class="col"></div>
							<div class="col-auto sale-order-list-repeat-container">
								<a class="bx-btn g-font-size-15 sale-order-list-repeat-link" href="<?=htmlspecialcharsbx($order["ORDER"]["URL_TO_COPY"])?>"><?=Loc::getMessage('SPOL_TPL_REPEAT_ORDER')?></a>
							</div>
							<div class="col-auto sale-order-list-cancel-container">
								<a class="bx-btn g-font-size-15 sale-order-list-cancel-link" href="<?=htmlspecialcharsbx($order["ORDER"]["URL_TO_CANCEL"])?>"><?=Loc::getMessage('SPOL_TPL_CANCEL_ORDER')?></a>
							</div>
						</div>
					</div>
				</div>
