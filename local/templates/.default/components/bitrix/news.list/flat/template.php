...
<?foreach($arResult["ITEMS"] as $arItem):?>
	...
	<div class="bx-newslist-block">
		...
		<?if($arParams["DISPLAY_PREVIEW_TEXT"]!="N" && $arItem["PREVIEW_TEXT"]):?>
			...
			<?echo my_crop($arItem["PREVIEW_TEXT"],150);?>
			</div>
		<?endif;?>
		...
		<?if($arParams["DISPLAY_DATE"]!="N" && $arItem["DISPLAY_ACTIVE_FROM"]):?>
			<div class="col-xs-5">
				<p class="date icon-calendar" style="font-weight: bold; margin-left: 15px; display: block;"> <?echo $arItem["DISPLAY_ACTIVE_FROM"]?></p>
			</div>
		<?endif?>
		...
		<div class="row">
			<div class="col-xs-5">
			<?if(!$arParams["HIDE_LINK_WHEN_NO_DETAIL"] || ($arItem["DETAIL_TEXT"] && $arResult["USER_HAVE_ACCESS"])):?>
				<div class="bx-newslist-more" style="margin-top: 15px; margin-bottom: 10px; margin-left: 10px;"><a class="button button--common button--primary" href="<?echo $arItem["DETAIL_PAGE_URL"]?>"><?echo GetMessage("CT_BNL_GOTO_DETAIL")?></a></div>
			<?endif;?>
			</div>
		<?
