					...
					events: {
						onAfterPopupShow: BX.delegate(function(){
							...
							this.loadingScreen.popupContainer.appendChild(
								BX.create('IMG', {props: {src: this.templateFolder + '/images/index.double-ring-spinner.svg'}})
							);
		...
		popupShow: function(e, url, source)
		{
			...
			this.popup = new BX.PopupWindow('bx-soa-image-popup', null, {
				...
				content: BX.create('DIV', {
					...
					children: [BX.create('IMG', {props: {src: this.templateFolder + "/images/index.double-ring-spinner.svg"}})]
				})
			});
			this.popup.show();
		},
