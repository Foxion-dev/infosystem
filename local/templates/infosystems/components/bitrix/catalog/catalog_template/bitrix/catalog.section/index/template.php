...
<div class="catalog-section-courses">
            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-6 col-lg-2">
                    <div class="nearest-courses-items-details">
                        ...
                        <?if(!empty($arElement['DISPLAY_PROPERTIES']['DATE']['VALUE'])){
	...
	<?//=$arResult["NAV_STRING"]?>
	<?//endif?>
	<div style="text-align: right;padding:20px 0px;"><a style="font-style: normal;font-weight: 600;font-size: 13px;line-height: 18px;text-transform: uppercase;color: #272727;" href="https://infosystems.ru/courses/">Все курсы ></a></div>
</div>
