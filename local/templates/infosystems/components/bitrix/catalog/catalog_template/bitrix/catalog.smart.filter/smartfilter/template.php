...
?>
<div id="smartfilter" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="mySmartFilter" aria-hidden="true">
            ...
            <div class="modal-body">
                <div class="bx-filter <?=$templateData["TEMPLATE_CLASS"]?>">
                    <div class="container bx-filter-section container-fluid">
                        ...
                        <form name="<?echo $arResult["FILTER_NAME"]."_form"?>" action="<?echo $arResult["FORM_ACTION"]?>" method="get" class="row coursers-line-form smartfilter">
                            <?foreach($arResult["HIDDEN"] as $arItem):?>
                            <input type="hidden" name="<?echo $arItem["CONTROL_NAME"]?>" id="<?echo $arItem["CONTROL_ID"]?>" value="<?echo $arItem["HTML_VALUE"]?>" />
                            <?endforeach;?>
                            <div class="col-12 col-sm-12 col-md-10 col-lg-11 col-xl-11"><div class="row">
                                <?foreach($arResult["ITEMS"] as $key=>$arItem)//prices
                                {
                                    ...
                                    if(isset($arItem["PRICE"])):
                                        ...
                                        ?>
                                        <div class="<?/*if ($arParams["FILTER_VIEW_MODE"] == "HORIZONTAL"):?>col-sm-6 col-md-4<?else:?>col-lg-12<?endif*/?> col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 bx-filter-parameters-box bx-active">
                                            <span class="bx-filter-container-modef"></span>
                                            <div class="bx-filter-parameters-box-title" onclick="smartFilter.hideFilterProps(this)"><span><?=GetMessage("PRISE_COURSE")?><?//=$arItem["NAME"]?> <i data-role="prop_angle" class="fa fa-angle-<?if ($arItem["DISPLAY_EXPANDED"]== "Y"):?>up<?else:?>down<?endif?>"></i></span></div>
                                            <div class="bx-filter-block" data-role="bx_filter_block">
                                                <div class="bx-filter-parameters-box-container">
                                                    <div class="bx-filter-parameters-box-container-block bx-left">
                                                        <div class="bx-filter-input-container">
                                                            <input placeholder="<?=GetMessage("CT_BCSF_FILTER_FROM")?>"
                                                                class="min-price"
                                                                type="text"
                                                    ...
                                                    <div class="bx-filter-parameters-box-container-block bx-right">
                                                        <div class="bx-filter-input-container">
                                                            <input placeholder="<?=GetMessage("CT_BCSF_FILTER_TO")?>"
                                                                class="max-price"
                                                                type="text"
                                ...
                                foreach($arResult["ITEMS"] as $key=>$arItem)
                                {
                                    ...
                                    if (
                                        ...
                                        continue;
                                    ?>
                                    <div class="<?if ($arParams["FILTER_VIEW_MODE"] == "HORIZONTAL"):?>col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6<?else:?>col-lg-12<?endif?> bx-filter-parameters-box <?if ($arItem["DISPLAY_EXPANDED"]== "Y"):?>bx-active<?endif?>">
                                        <span class="bx-filter-container-modef"></span>
                                        ...
                                        <div class="bx-filter-block" data-role="bx_filter_block">
                                            <div class="<?=(!in_array($arItem["DISPLAY_TYPE"],['P','U'])?"row":"")?> bx-filter-parameters-box-container">
                                            <? //p($arItem["DISPLAY_TYPE"],'p');
                                            ...
                                            switch ($arItem["DISPLAY_TYPE"])
                                            {
                                                ...
                                                case "U"://CALENDAR
                                                    ?>
                                                    <div>
                                                        <div class="bx-filter-parameters-box-container-block bx-left"><div class="bx-filter-input-container bx-filter-calendar-container">
                                                        ...
                                                        <div class="bx-filter-parameters-box-container-block bx-right"><div class="bx-filter-input-container bx-filter-calendar-container">
                                                            <?$APPLICATION->IncludeComponent('bitrix:main.calendar','',
                                                                array(
                                                                    'FORM_NAME' => $arResult["FILTER_NAME"]."_form",
                                                                    'SHOW_INPUT' => 'Y',
                            ...
                            <div class="col-12 col-sm-12 col-md-2 col-lg-1 col-xl-1">
                                <div class="bx-filter-button-box">
                                    <div class="bx-filter-block">
                                        <div class="bx-filter-parameters-box-container">
                                            <button type="submit" id="set_filter" name="set_filter" class="button button--round button--secondary icon-search"></button>
                                            <button type="submit" id="del_filter" name="del_filter" class="btn btn-link del_filter"><?=GetMessage("CT_BCSF_DEL_FILTER")?></button>
                                            <?/*<input
