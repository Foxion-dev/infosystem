                ...
                <div class="timetable__content calendar-table">
                    ...
                    <div class="calendar-table__head flex-block">
                        ...
                        <div class="calendar-table__links-box  flex-block">
                            <a href="javascript: void(0)" data-view='M'
                               class="calendar-table__link flex-block js-tab-view-link active ">Месяц</a>
                            <a href="javascript: void(0)" data-view='W'
                               class="calendar-table__link js-tab-view-link  flex-block">Неделя</a>
                            <a href="javascript: void(0)" data-view='D'
                               class="calendar-table__link js-tab-view-link flex-block">День</a>
                        </div>
                    ...
                    <div class="calendar-table__content  flex-block js-tab-view-content active" data-view='M'>
                        ...
                        <div class="calendar-table__row">
                                    ...
                                    <div class="events-list__item flex-block">
                                        ...
                                        <div class="events-list__item-detail event-info event-info--admin">
                                            ...
                                            <div class="event-info__description">
                                                ...
                                                <a href="cource-index.html" class="txt-info hover-link">Обеспечение
                                                    безопасности персональных данных при их обработке в информационных
                                                    системах персональных данных (Программа согласована ФСТЭК
                                                    России)</a>
                                            </div>
                            ...
                            <div class="calendar-table__item flex-block">
                                <h6 class="calendar-table__item-title">04</h6>
                            </div>
                            <div class="calendar-table__item flex-block">
                                <h6 class="calendar-table__item-title">05</h6>
                            </div>
                            <div class="calendar-table__item flex-block">
                                <h6 class="calendar-table__item-title">06</h6>
                            </div>
                            <div class="calendar-table__item flex-block">
                                <h6 class="calendar-table__item-title">07</h6>
                            </div>
                        </div>
                        <div class="calendar-table__row">
                            <div class="calendar-table__item">
                            ...
                            <div class="calendar-table__item flex-block">
                                <h6 class="calendar-table__item-title">11</h6>
                            </div>
                            <div class="calendar-table__item flex-block">
                                <h6 class="calendar-table__item-title">12</h6>
                            </div>
                            <div class="calendar-table__item flex-block">
                                <h6 class="calendar-table__item-title">13</h6>
                            </div>
                            <div class="calendar-table__item flex-block">
                                <h6 class="calendar-table__item-title">14</h6>
                            </div>
                        </div>
                        <div class="calendar-table__row">
                            <div class="calendar-table__item">
                            ...
                            <div class="calendar-table__item flex-block">
                                <h6 class="calendar-table__item-title">18</h6>
                            </div>
                            <div class="calendar-table__item flex-block">
                                <h6 class="calendar-table__item-title">19</h6>
                            </div>
                            <div class="calendar-table__item flex-block">
                                <h6 class="calendar-table__item-title">20</h6>
                            </div>
                            <div class="calendar-table__item flex-block">
                                <h6 class="calendar-table__item-title">21</h6>
                            </div>
                        </div>
                        <div class="calendar-table__row">
                            <div class="calendar-table__item">
                                ...
                                <div class="calendar-table__item-content events-list">
                                    ...
                                    <!-- <div class="events-list__item flex-block">
                                        ...
                                        <span class="events-list__item-preview js-open-detail">X645-2342</span>
                                ...
                                <div class="calendar-table__item-content events-list">
                                    <div class="events-list__item flex-block">
                                        ...
                                        <div class="events-list__item-detail event-info event-info--admin">
                                            ...
                                            <div class="event-info__description">
                                                <span class="txt-info bold">Курс: </span>
                                                <a href="cource-index.html" class="txt-info hover-link">Astra Linux.
                                                    Специальный курс</a>
                                            </div>
                                            <span class="event-info__date bold">Пятница, 14.05  - 09:00 - 10:00</span>
                                            <ul class="event-info__dop-info-list">
                            ...
                            <div class="calendar-table__item flex-block">
                                <h6 class="calendar-table__item-title">25</h6>
                            </div>
                            <div class="calendar-table__item flex-block">
                                <h6 class="calendar-table__item-title">26</h6>
                            </div>
                            <div class="calendar-table__item flex-block">
                                <h6 class="calendar-table__item-title">27</h6>
                            </div>
                            <div class="calendar-table__item flex-block">
                                <h6 class="calendar-table__item-title">28</h6>
                            </div>
                        </div>
                        <div class="calendar-table__row">
                            <div class="calendar-table__item">
                            ...
                            <div class="calendar-table__description-box flex-block">
                                <?php foreach ($arResult['STATUSES'] as $status): ?>
                                    <div class="calendar-table__description-item  flex-block">
                                        <span class="calendar-table__description-icon icon-circle icon-circle--<?= $status['UF_COLOR'] ?>"></span>
                                        <span class="calendar-table__description-text bold">
                                            <?= sprintf('Статус курса «%s»', $status['UF_NAME']) ?>
                                        </span>
                                    </div>
                                <?php endforeach ?>
                            </div>
                                ...
                                <td colspan="6">
											<span class="day-table__item">
												<div class="day-table__item-top">
													...
													<a href="##" class="day-table__item-text hover-link">Astra Linux. Специальный курс</a>
												</div>
												<div class="day-table__item-bottom">
													<span class="day-table__item-text bold">12:00 - 18:00</span>
												</div>
