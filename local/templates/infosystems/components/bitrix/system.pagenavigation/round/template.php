...
if(stripos($arResult["NavQueryString"], '?PAGEN') || stripos($arResult["NavQueryString"], 'ajaxCoursesList=Y')){
    $strNavQueryStringFull = ($arResult["NavQueryString"] != "" ? "?".$arResult["NavQueryString"] : "");
}else{
    $strNavQueryStringFull = '?ajaxCoursesList=Y';
}
...
<div class="bx-pagination <?=$colorScheme?> history-save">
