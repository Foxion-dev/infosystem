(function ($) {
    ...
    Paginator.prototype.historyAdd = function () {
        var self = this;
        //html5 history api
        var UrlPushState = ($.param(self.o.params)? self.o.query + '?' + $.param(self.o.params): self.o.query);
        history.pushState(null, null, UrlPushState);
        // lazy flag off
        self.isLazy = false;
    };
