...
//
/* $APPLICATION->IncludeComponent('acs:acs.courses','courses_section',
...
<?if(isset($_GET['ajax_coursesReviews'])&&$_GET['ajax_coursesReviews']=='Y'){
...
<?if(isset($_GET['ajax_coursesClosest'])&&$_GET['ajax_coursesClosest']=='Y'){
	$APPLICATION->RestartBuffer();
	$section=0;
    if(!empty($_POST['coursers-line-name'])){
        $section=$_POST['coursers-line-name'];
	...
	$intSectionID=$APPLICATION->IncludeComponent("bitrix:catalog.section","index",
        array(
            "IBLOCK_TYPE" => $arParams["IBLOCK_TYPE"],
            "IBLOCK_ID" => $arParams["IBLOCK_ID"],
...
<section class="nearest-courses" role="main">
	...
	<?$APPLICATION->IncludeComponent('acs:filter',".default",[
		...
		<?if(isset($_REQUEST["FREE"]) && $_REQUEST["FREE"] == "Y"){
			$catalog_custom_sort["PROPS"] = "PROPERTY_WEBINAR_RECORDING";
			$catalog_custom_sort["ORDER"] = "DESC";
		}?>
    ...
    <? $intSectionID = $APPLICATION->IncludeComponent("bitrix:catalog.section","index",
        array(
            ...
            "IBLOCK_ID" => $arParams["IBLOCK_ID"],
            "SHOW_ALL_WO_SECTION" => "Y", // [Y|N] При отмеченной будут отображены все элементы, если не указан раздел.
            "ELEMENT_SORT_FIELD" => $catalog_custom_sort['PROPS'],
            "ELEMENT_SORT_ORDER" => $catalog_custom_sort['ORDER'],
            "ELEMENT_SORT_FIELD2" => $arParams["ELEMENT_SORT_FIELD2"],
            "ELEMENT_SORT_ORDER2" => $arParams["ELEMENT_SORT_ORDER2"],
            "PROPERTY_CODE" => $arParams["LIST_PROPERTY_CODE"],
            "PROPERTY_CODE_MOBILE" => $arParams["LIST_PROPERTY_CODE_MOBILE"],
