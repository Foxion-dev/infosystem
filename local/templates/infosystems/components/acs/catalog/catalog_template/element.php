...
/* шаблон элемента и т.д. */
$elementId = $APPLICATION->IncludeComponent('bitrix:catalog.element','.default',
...
$res = CIBlockElement::GetList(['SORT'=>'ASC'],['IBLOCK_ID'=>$arParams['IBLOCK_ID'],'ID'=>$elementId],false,false,['ID','PROPERTY_RECOMMEND']);
$recommened_course=[];
while($r=$res->Fetch()){ $recommened_course[]=$r['PROPERTY_RECOMMEND_VALUE'];}
//var_dump($recommened_course);
//global $filt;
//$filt=['ID'=>$recommened_course]
$APPLICATION->IncludeComponent('acs:acs.courses','courses_carousel',[
	'CACHE_TYPE' => 'N',
    'CACHE_TIME' => $arParams['CACHE_TIME'],
    'CACHE_GROUPS' => 'N',
    'IBLOCK_TYPE' => $arParams['IBLOCK_TYPE'],
