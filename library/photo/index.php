...
$APPLICATION->SetTitle("Фотогалерея АИС");
$APPLICATION->SetPageProperty("particlesBG", "Y");
?>
<div class="have-margin-top">
<?$APPLICATION->IncludeComponent("bitrix:news", "photos", Array(
    "IBLOCK_TYPE" => "library",	// Тип инфоблока
    "IBLOCK_ID" => "6",	// Инфоблок
    "TEMPLATE_THEME" => "site",	// Цветовая тема
    "NEWS_COUNT" => "20",	// Количество на странице
    ...
    "SEF_FOLDER" => "/library/photo/",	// Каталог ЧПУ (относительно корня сайта)
    ...
    "LIST_ACTIVE_DATE_FORMAT" => "Y",	// Формат показа даты d F Y
    ...
    "DETAIL_ACTIVE_DATE_FORMAT" => "Y",	// Формат показа даты d F Y
    ...
    "PAGER_TITLE" => "Фото",	// Название категорий
