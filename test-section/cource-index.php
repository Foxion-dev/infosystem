			...
			<section class="timetable timetable--mounth timetable--user">
				<div class="container">
					...
					<div class="timetable__course-info course-info flex-block">
						<div class="course-info__column info-list info-list--user">
						...
						<div class="course-info__column info-list">
							<div class="info-list__item flex-block">
					...
					<div class="timetable__content calendar-table">
						<div class="calendar-table__head flex-block">
							...
							<div class="calendar-table__links-box  flex-block">
								<a href="javascript: void(0)" data-view='M' class="calendar-table__link flex-block active js-tab-view-link ">Месяц</a>
						...
						<div class="calendar-table__content flex-block js-tab-view-content "  data-view='D'>
							<table class="day-table">
									...
									<tr  class="day-table__row">
										<th><span class="day-table__title">Обеспечение безопасности персональных данных при их обработке в информационных системах персональных данных (Программа согласована ФСТЭК России)</span></th>
									...
									<tr class="day-table__row">
										<th><span class="day-table__title">Astra Linux. </br>Специальный курс</span></th>
										<td><span class="day-table__item"></span></td>
										<td><span class="day-table__item"></span></td>
										<td><span class="day-table__item"></span></td>
										<td><span class="day-table__item"></span></td>
